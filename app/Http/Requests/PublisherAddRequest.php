...
class PublisherAddRequest extends FormRequest
{
    ...
    {
        return [
            'publisher_code' => 'required|min:3|max:100|unique:publisher,publisher_code',
            'publisher_name' => 'required|min:3|max:100|unique:publisher,publisher_name',
    ...
    public function messages()
    {
       return [
        ...
        'publisher_code.unique' => 'Mã NXB đã tồn tại',
        ...
        'publisher_name.unique' => 'Tên NXB  đã tồn tại',
